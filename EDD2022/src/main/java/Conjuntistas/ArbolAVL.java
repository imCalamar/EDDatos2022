...
public class ArbolAVL {
    ...
    private boolean insertarAux(NodoAVL n, Comparable elem, NodoAVL padre) {
        ...
        if (elem.compareTo(n.getElem())==0) {
            ...
            if (elem.compareTo(n.getElem())<0) {
                ...
                if (n.getIzq() != null) {
                    res = insertarAux(n.getIzq(), elem,n);
                    n.recalcularAltura(); 
                } else {
                ...
                if (n.getDer() != null) {
                    res = insertarAux(n.getDer(), elem,n);
                    n.recalcularAltura();                 
                } else {
    ...
    public void eliminar(Comparable elem) {
    ...
    private NodoAVL obtenerNodoPadre(NodoAVL n, Comparable elem) {
        NodoAVL res = null;
        if (n != null) {
