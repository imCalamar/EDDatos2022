...
//
        ...
        System.out.println("\t--> " + p1.toString());
        System.out.print("Apila 2 espera TRUE y [1,2]:\t\t\t\t" + ((p1.insertar(1, 2)) ? sOk : sErr));
        System.out.println("\t--> " + p1.toString());
        System.out.print("Apila 3 espera TRUE y [1,2,3]:\t\t\t\t" + ((p1.insertar(1, 3)) ? sOk : sErr));
        System.out.println("\t--> " + p1.toString());
        System.out.print("Apila 4 espera TRUE y [1,2,3,4]:\t\t\t" + ((p1.insertar(1, 4)) ? sOk : sErr));
        System.out.println("\t--> " + p1.toString());
//        System.out.print("Apila 5 espera TRUE y [1,2,3,4,5]:\t\t\t" + ((p1.insertar(5, 5)) ? sOk : sErr));
//        System.out.println("\t--> " + p1.toString());
//        System.out.print("Apila 6 espera TRUE y [1,2,3,4,5,6]:\t\t\t" + ((p1.insertar(1, 6)) ? sOk : sErr));
//        System.out.println("\t--> " + p1.toString());
...
//        System.out.println("\t--> " + p1.toString());
//        System.out.print("Apila 11 espera false en estatica true en dinamica:\t" + p1.insertar(1, 11));
//        System.out.println("\t--> " + p1.toString());
//        
        Lista p2 = p1.clone();
        System.out.println("Copia : \t\t\t\t--> " + p2.toString());
        
        Lista p3 = p1.obtenerMultiplos(4);
        System.out.println("multiplos : \t\t\t\t--> " + p3.toString());
        
        p1.eliminarApariciones(1);
        System.out.println("apariciones : \t\t\t\t--> " + p1.toString());
    }
